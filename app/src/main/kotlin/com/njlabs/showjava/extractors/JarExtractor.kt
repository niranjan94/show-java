...
/**
 * The [JarExtractor] worker handles optimization and extraction of the jar/dex file from the source
 *
 ...
 */
class JarExtractor(context: Context, data: Data) : BaseExtractor(context, data) {
    ...
    override val maxMemoryAdjustmentFactor = 1.65
